...
namespace at.jku.ssw.cc
{
    ...
    class Parser
    {
        ...
        static void Program()
        {
            ...
            Program1.form1.treeView1.Nodes.Add(program);
            Program1.form1.treeView1.ExpandAll();//"cuelga" el nodo (raiz) "program" del treeView1 ya creado
            ...
            program.ExpandAll();//Cuelga un TreeNode porque PosDeclars es No Terminal
            Parser.MessageBoxCon3Preg();
        ...
        static void MethodDecl(System.Windows.Forms.TreeNode methodDeclsopc)
        {
            ...
            if (la == Token.VOID || la == Token.IDENT)
            {
                ...
                else
                {
                    ...
                    pars.ExpandAll(); //"Expand()" y "ExpandAll" hacen lo mismo.
                    MessageBoxCon3Preg();
        ...
        static void Block(System.Windows.Forms.TreeNode methodDecl)
        {
            ...
            while (la != Token.RBRACE)
            {
                    ...
                    else
                    {
                        ...
                        if (la != Token.LBRACE && la != Token.EOF)
                        {
                            if (la == Token.TYPE)
                            {
                                ...
                                DeclarationInsideMethod.ExpandAll();
                                MessageBoxCon3Preg();
                                Code.seleccLaProdEnLaGram(6);
                                MessageBoxCon3Preg();
                ...
                {
                    //Si no se cumple esta condición es que llegamos al final "}", y debe salir del While
                    if (la != Token.RBRACE)
                    {
